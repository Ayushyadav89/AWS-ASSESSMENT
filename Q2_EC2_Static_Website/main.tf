...
# Create a small VPC + public subnet for the EC2 instance (isolated for this task)
...
# EC2 instance with user-data to install nginx and place a simple resume page
