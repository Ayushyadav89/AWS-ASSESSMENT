...
# Create VPC + public and private subnets (for HA)
...
# Security Group for ALB and instances
...
# Launch Template for ASG instances (user_data installs nginx and simple page)
